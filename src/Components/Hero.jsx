  ...
  return (
    <div>
      <div className='bg-[#d44dbb] w-full h-screen p-6 md:p-14'>
        <h1 className='font-Poppins text-2xl md:text-4xl font-bold text-center animate-fade-right animate-once animate-ease-linear animate-fill-both'>TODO LIST<br />WELCOME BACK!!</h1>
